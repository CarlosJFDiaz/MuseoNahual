...
<section id="bienvenidos">
                <div class="group" align="center">
                    <form name="registro" method="post" action="update_r.php">
                    <h2><em>Modificar producto</em></h2> <br> 
                       ...
                       <left> <input name="boton" type="submit" value="Modificar Producto" /></left><br><br>
                      </p>
                    </form>
                  </div><br>
